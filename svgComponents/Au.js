...
const SvgAu = props => (
    <Svg viewBox="0 0 21 15" width={21} height={15} {...props}>
        <Defs>
            ...
            <LinearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="AU_svg__b">
        ...
        <G fill="none" fillRule="evenodd" clipPath={props.shape === 'circle' ? "url(#clip)" : undefined}>
            <Path fill="url(#AU_svg__a)" d="M0 0h21v15H0z" />
            <Path fill="url(#AU_svg__b)" d="M0 0h21v15H0z" />
            <Path
            ...
            <Path
                ...
                fill="url(#AU_svg__a)"
            />
            <Path fill="url(#AU_svg__c)" d="M0 3h4V0h1v3h4v1H5v3H4V4H0z" />
            <Path
                fill="#FFF"
