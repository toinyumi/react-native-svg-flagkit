...
const SvgVi = props => (
    <Svg viewBox="0 0 21 15" width={21} height={15} {...props}>
        <Defs>
            <LinearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="VI_svg__a">
                <Stop stopColor="#FFF" offset="0%" />
                <Stop stopColor="#F0F0F0" offset="100%" />
            </LinearGradient>
            <LinearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="VI_svg__b">
                <Stop stopColor="#F8CE61" offset="0%" />
                <Stop stopColor="#F3C44B" offset="100%" />
            </LinearGradient>
            <Path
            ...
            <Path
                ...
                id="VI_svg__d"
            />
            <LinearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="VI_svg__e">
                <Stop stopColor="#1E357F" offset="0%" />
                <Stop stopColor="#162966" offset="100%" />
            </LinearGradient>
            <LinearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="VI_svg__g">
        ...
        <G fill="none" fillRule="evenodd" clipPath={this.props.shape === 'circle' ? "url(#clip)" : undefined}>
            ...
            <Path
                ...
                fillRule="nonzero"
            />
            <Use fill="url(#VI_svg__b)" xlinkHref="#VI_svg__c" />
            <Path
                strokeOpacity={0.08}
                stroke="#000"
                strokeWidth={0.5}
            ...
            <G transform="translate(8 4)">
                <Mask id="VI_svg__f" fill="#fff">
                    <Use xlinkHref="#VI_svg__d" />
                </Mask>
                <Use fill="url(#VI_svg__a)" xlinkHref="#VI_svg__d" />
                <Path
                    fill="url(#VI_svg__e)"
                    mask="url(#VI_svg__f)"
                    d="M0 0h5v2H0z"
