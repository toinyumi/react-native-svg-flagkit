...
const SvgLu = props => (
    <Svg viewBox="0 0 21 15" width={21} height={15} {...props}>
        ...
        <G fill="none" fillRule="evenodd" clipPath="url(#clip)">
            <Path fill="url(#LU_svg__a)" d="M0 0h21v15H0z" />
            <Path fill="url(#LU_svg__b)" d="M0 0h21v5H0z" />
            <Path fill="url(#LU_svg__c)" d="M0 10h21v5H0z" />
            <Path fill="url(#LU_svg__a)" d="M0 5h21v5H0z" />
        </G>
    </Svg>
)
